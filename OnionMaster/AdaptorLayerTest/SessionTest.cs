...
namespace AdaptorLayer
{
    ...
    public class SessionTest
    {
        ...
        {
            var session = new Session("", new InputMock(true, false, false, false, false), _useCasesMock);
            session.Update();
        ...
        {
            var session = new Session("", new InputMock(false, false, false, false, false), _useCasesMock);
            session.Update();
        ...
        {
            var session = new Session("", new InputMock(false, true, false, false, false), _useCasesMock);
            session.Update();
        ...
        {
            var session = new Session("", new InputMock(false, false, true, false, false), _useCasesMock);
            session.Update();
        ...
        {
            var session = new Session("", new InputMock(false, false, false, true, false), _useCasesMock);
            session.Update();
        ...
        {
            var session = new Session("", new InputMock(false, false, false, false, true), _useCasesMock);
            session.Update();
        ...
        public void Should_show_all_renderable_objects_when_draw_to_screen()
        {
            ...
            var session = new Session("", new InputMock(), _useCasesMock);
